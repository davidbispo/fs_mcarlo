...
gdbpar = r'C:\Users\david\Desktop\fs_mcarlo\parameters.gdb'
saida = r'C:\Users\david\Desktop\fs_mcarlo'
#slope = r'C:\Users\david\Desktop\fatseg\fatseg\Solucao\workshop5.gdb\slope_RAD'
#criarasters_par(slope,gdbpar,coes=True, coes_val=11, ang_at=True, ang_at_val=19, suct = True, suct_val = 0.)
#calculaFS(gdbpar)

gdbscen = r'C:\Users\david\Desktop\fs_mcarlo\scenarios.gdb'

simulaFS(gdb_par = gdbpar, gdb_scenarios = gdbscen, var_max_ang_atrito = 6 , var_max_coesao = 6,var_max_suct = 2, nsim = 5,logout = saida)
